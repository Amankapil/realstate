    ...
    <>
      <div className="by-area mt-20">
        <div className="main-area">
          <div className="head-area ml-[60px]">
            <div className="w-full h-[104px] max-lg:h-full flex-col justify-start items-start gap-6 inline-flex">
              <div className="text-neutral-800 text-[13px] font-medium font-['Manrope'] uppercase leading-none tracking-wide">
                Explore by area
              </div>
              <div className="w-[60%] text-neutral-800 text-[49px] font-normal font-['Manrope'] leading-[63.70px]">
                Our projects in San Francisco
              </div>
            </div>
          </div>

          <div className="main-cards-property max-lg:px-5 px-[60px] flex justify-start items-center max-lg:justify-center max-lg:items-center flex-wrap gap-[58px] mt-20 ">
        ...
        <div className="main-area">
          <div className="head-area ml-[60px]">
            <div className="w-full h-[104px] max-lg:h-full flex-col justify-start items-start gap-6 inline-flex">
              ...
              <div className="w-[60%] text-neutral-800 text-[49px] font-normal font-['Manrope'] leading-[63.70px]">
                Our projects in Philadelphia
              </div>
            </div>
          </div>

          <div className="main-cards-property px-[60px] max-lg:px-5 flex justify-start items-center flex-wrap gap-[58px] mt-20 max-lg:justify-center max-lg:items-center">
            <div className="project-card flex-col justify-start items-start gap-9 inline-flex w400px]">
              <div className="flex-col justify-start items-start gap-8 flex">
                <img
                  className=" h-[258px] relative"
